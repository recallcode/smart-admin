...
public class EnterpriseService {
    ...
    public ResponseDTO<PageResult<EnterpriseVO>> queryByPage(EnterpriseQueryForm queryForm) {
        ...
        Page<EnterpriseVO> enterpriseVOPage = new Page<>(page.getCurrent(), page.getSize());
        List<EnterpriseVO> enterpriseList = enterpriseDao.queryPage(enterpriseVOPage, queryForm);
